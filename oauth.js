...
function authenticate(client, pcEnvironment, state) {
    ...
    const platformEnvironment = pcEnvironment === 'localhost' ? 'mypurecloud.ie' : pcEnvironment;
    /*
    ...
    */
    const pcOAuthClientIds = {'mypurecloud.ie': 'c60a35ff-3e6a-4f7b-9f92-e68c31dfa57d'};
